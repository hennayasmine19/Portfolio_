...
export const DraggableCardsBox = ({
  className,
  children,
}: {
  className?: string;
  ...
  return (
    <ContainerContext.Provider value={containerRef}>
      <div 
        ref={containerRef}
        className={cn("relative w-full min-h-[600px] overflow-hidden rounded-xl border-2 border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 p-8", className)}
      >
        {children}
      </div>
